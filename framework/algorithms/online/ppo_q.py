...
class Algorithm:
    ...
    """
    PPO-style clipped actor update with twin Q critics instead of a V network:
      - needs Q instead of v the the specific aggregation method
    ...
    def __init__(self, args, device, dtype, stats_path):
        ...
        print(
            f"Initialized PPO (Twin Q) with clip_eps={self.clip_eps}, entropy_coef={self.entropy_coef}, "
        ...
        with open(stats_path, mode="w", newline="") as f:
            ...
            w.writerow(
                [
                    ...
                    "avg_loss_td", "avg_loss_actor", "avg_advantage", "avg_entropy", "avg_ratio",
                ]
            )
